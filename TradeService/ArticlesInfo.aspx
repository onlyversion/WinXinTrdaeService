<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="ArticlesInfo.aspx.cs"
    Inherits="TradeService.ArticlesInfo" %>
        ...
        <table width="100%" class="newsinfo_tab">
          <tr>
            <td colspan="2" bgcolor="#d0e1e9" style="height: 24px">
              <img alt="" src="Img/titleIcon.gif" /><span style="color: #4073B6;" runat="server" id="spanMessage"> 理财师说</span>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <asp:DropDownList runat="server" ID="ddlType">
                ...
                <%--  <asp:ListItem Value="1">新闻</asp:ListItem>
                  ...
                  <asp:ListItem Value="3">理财师说</asp:ListItem>
              </asp:DropDownList>
              状&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;态：
